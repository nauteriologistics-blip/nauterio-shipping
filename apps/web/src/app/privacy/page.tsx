...
const sections = [
  ...
  ["5. Sharing", "Information may be shared only as needed with carriers, brokers, warehouses, payment providers, technology providers, professional advisers, and competent authorities. Nauterio does not sell personal data."],
