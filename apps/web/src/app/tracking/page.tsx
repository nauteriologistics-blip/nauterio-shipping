  ...
  return (
    <div className="max-w-3xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold text-[#081F3D] mb-6">Track Your Shipment</h1>
        ...
        <div className="mt-6 flex flex-wrap justify-center items-center gap-3">
          <span className="text-sm text-gray-500 py-1">Sample tracking IDs:</span>
          {SAMPLE_IDS.map((id) => (
            <button
              key={id}
              onClick={() => {
      ...
      {isLoading && (
        <p className="text-center text-gray-500" role="status">Loading&hellip;</p>
      )}
      ...
      {!isLoading && searched && !shipment && (
        <div className="bg-gray-50 border border-gray-100 rounded-2xl p-10 text-center">
          ...
          <p className="text-gray-500">We couldn&apos;t find any details for tracking number &quot;{query}&quot;. Please check the number and try again.</p>
        </div>
      )}
          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex flex-col text-right">
                <span className="text-sm text-gray-500 mb-1">Destination</span>
            ...
            <p className="text-sm text-gray-500">
              Estimated delivery: <span className="font-medium text-gray-900">{shipment.estimatedDelivery}</span>
            </p>
          </div>

          {/* Timeline */}
          <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
            <h3 className="text-lg font-bold text-[#081F3D] mb-8">Tracking History</h3>
...
export default function TrackingPage() {
  return (
    <div className="min-h-screen bg-white">
      <Suspense fallback={<div className="py-24 text-center">Loading&hellip;</div>}>
        <TrackingContent />
      </Suspense>
    </div>
  );
