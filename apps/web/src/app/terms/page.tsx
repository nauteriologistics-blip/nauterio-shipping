...
const sections = [
  ["1. Shipment acceptance", "Registration, estimates, requests, and demonstrations do not by themselves create a contract of carriage. A shipment becomes accepted only after Nauterio has reviewed it, issued final commercial terms, and expressly confirmed acceptance."],
  ...
  ["9. Final legal details", "The operating legal entity, registered address, governing law, formal-notice address, and versioned commercial terms must be confirmed in the applicable final quote, invoice, or signed customer agreement. No placeholder company number, tax number, warehouse address, or legal mailbox should be treated as official."],
] as const;
