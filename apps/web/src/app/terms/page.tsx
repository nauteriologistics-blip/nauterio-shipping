...
const sections = [
  ["1. Pre-launch status", "Nauterio is currently operating as a pre-launch platform. Registration, quotes, pilot workflows, and demonstrations do not by themselves create a contract of carriage. A shipment becomes accepted only after Nauterio has reviewed it, issued final commercial terms, and expressly confirmed acceptance."],
  ...
  ["9. Final legal details", "The operating legal entity, registered address, governing law, formal-notice address, and versioned commercial terms will be published and reviewed by qualified counsel before general commercial launch. No placeholder company number, tax number, warehouse address, or legal mailbox should be treated as official."],
] as const;
    ...
    <main className="min-h-screen bg-slate-50 py-16 lg:py-24">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="mt-8 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm text-amber-900">
          These terms intentionally omit unverified company registrations, addresses, rates, liability caps, and jurisdictions. Those items require business and legal approval before launch.
        </div>
        ...
        <p className="mt-8 text-sm text-slate-600">
          For a pre-launch business or legal inquiry, use the <Link href="/business" className="font-semibold text-[#081F3D] underline">business inquiry form</Link>.
        </p>
      </div>
    </main>
  );
