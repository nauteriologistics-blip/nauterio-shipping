...
export const TRACKING_STATUS_META: Record<TrackingStatus, TrackingStatusMeta> = {
  ...
  DEPARTED_ORIGIN: { code: "DEPARTED_ORIGIN", customerLabel: "Departed origin country", actionRequired: false, requiresStrongEvidence: false },
  ...
  ARRIVED_DESTINATION: { code: "ARRIVED_DESTINATION", customerLabel: "Arrived in destination country", actionRequired: false, requiresStrongEvidence: false },
